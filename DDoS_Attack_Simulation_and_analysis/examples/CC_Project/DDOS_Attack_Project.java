 ...
 * cloudlet on it.
 */
public class DDOS_Attack_Project {
	
	static int noOfCldlets;
	...
	private static List<Vm> createVM(int userId, int vms, int idShift) {
		...
		for(int i=0;i<vms;i++){
			...
			list.add(vm[i]);
			Log.printLine("vm "+(idShift + i) + " is sucessfully been initialized");
		}
	...
	public static void main(String[] args) {
		...
		try {
			...
			if(attack.equals("yes")||attack.equals("Yes") ) {
				...
				//cloudlets that attack on a perticular vm(attackVmId)
			...
			Log.printLine("CloudSim operation finished!");
		} catch (Exception e) {
			e.printStackTrace();
